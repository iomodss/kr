...
0 > document.querySelector("script[src*='js/____']").src.indexOf("xsxfBl") && (alert("[HACK IS ON UPDATING PROGRESS] CHECK DAILY or TRY DOWNLOAD FROM. https://iomods.org"), location.href = "https://iomods.org");
