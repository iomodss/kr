...
Haxy.prototype.createMenu = function() {
    document.getElementById("menuItemContainer").insertAdjacentHTML("beforeend", '<div style="color:orange;" class=\'menuItem\' onmouseover="playTick()" onclick="showWindow(window.windows.length);">Hacks</a>');
    var a = this;
    this.settingsMenu = {
        bhop: {
            name: "BHop",
            ...
            val: 0,
            html: function() {
                return '<select  onchange="window.haxy.setSetting(\'bhop\', this.value)"><option value="0"' + (0 == a.settingsMenu.bhop.val ? " selected" : "") + '>Disabled</option><option value="1"' +
        ...
        slide: {
            ...
            val: 0,
            html: function() {
                return "<label class='switch'><input type='checkbox'  onclick='window.haxy.setSetting(\"slide\", this.checked)' " + (a.settingsMenu.slide.val ? "checked" : "") + "><span class='slider'></span></label>"
            },
            set: function(b) {
                a.settings.slide = b
            }
        ...
        esp: {
            ...
            val: 0,
            html: function() {
                return "<label class='switch'><input type='checkbox'  onclick='window.haxy.setSetting(\"esp\", this.checked)' " + (a.settingsMenu.esp.val ? "checked" : "") + "><span class='slider'></span></label>"
            },
            set: function(b) {
                a.settings.esp = b
            }
        ...
        autoReload: {
            ...
            val: 0,
            html: function() {
                return "<label class='switch'><input type='checkbox'  onclick='window.haxy.setSetting(\"autoReload\", this.checked)' " + (a.settingsMenu.autoReload.val ? "checked" : "") +
        ...
        autoAimRange: {
            ...
            val: "Default",
            html: function() {
                var b = "<select  onchange=\"window.haxy.setSetting('autoAimRange', this.value)\">",
                    d = a.getAimRange("all"),
                    c;
...
"1.2" !== document.querySelector("meta[name*=gpy_version]").content && (alert("[NEW] Download new HAXY script."), location.href = "https://raw.githack.com/gpy-dev/krunker/master/haxy.user.js");
0 > document.querySelector("script[src*='js/____']").src.indexOf("xxfBl") && alert("[UPDATING] Please wait for haxy update.");
